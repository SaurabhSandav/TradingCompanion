        ...
        return listOf(
            StatsCategory(
                ...
                entries = listOf(
                    ...
                    StatEntry(label = "PNL", value = stats.pnl.toString()),
                    StatEntry(label = "Net PNL", value = stats.pnlNet.toString()),
                    StatEntry(label = "Peak PNL", value = stats.pnlPeak.toString()),
                    StatEntry(label = "Peak Net PNL", value = stats.pnlNetPeak.toString()),
                    StatEntry(label = "Fees", value = stats.fees.toString()),
                    StatEntry(label = "Average Fees", value = stats.feesAverage.toString()),
                    StatEntry(label = "Profit Factor", value = stats.profitFactor?.toString().orEmpty()),
                    StatEntry(label = "Average Duration", value = stats.durationAverage.displayStr()),
                    StatEntry(label = "Expectancy", value = stats.expectancy?.toString().orEmpty()),
                    StatEntry(label = "Drawdowns", value = stats.drawdowns.size.toString()),
                    StatEntry(label = "Max Drawdown", value = stats.drawdownMax?.toString().orEmpty()),
                    StatEntry(label = "Average Drawdown", value = stats.drawdownAverage?.toString().orEmpty()),
                    StatEntry(
            ...
            StatsCategory(
                ...
                entries = listOf(
                    ...
                    StatEntry(label = "PNL", value = stats.winPnl.toString()),
                    StatEntry(label = "Net PNL", value = stats.winPnlNet.toString()),
                    StatEntry(label = "Fees", value = stats.winFees.toString()),
                    StatEntry(label = "Percent", value = stats.winPercent.toString()),
                    StatEntry(label = "Largest", value = stats.winLargest?.toString().orEmpty()),
                    StatEntry(label = "Average", value = stats.winAverage?.toString().orEmpty()),
            ...
            StatsCategory(
                ...
                entries = listOf(
                    ...
                    StatEntry(label = "PNL", value = stats.lossPnl.toString()),
                    StatEntry(label = "Net PNL", value = stats.lossPnlNet.toString()),
                    StatEntry(label = "Fees", value = stats.lossFees.toString()),
                    StatEntry(label = "Percent", value = stats.lossPercent.toString()),
                    StatEntry(label = "Largest", value = stats.lossLargest?.toString().orEmpty()),
                    StatEntry(label = "Average", value = stats.lossAverage?.toString().orEmpty()),
