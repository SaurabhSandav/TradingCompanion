...
fun pctChangeStrategy(percentChange: BigDecimal = "0.5".toBigDecimal()) = Strategy(
    title = "% Change Strategy (> ${percentChange.toPlainString()}%)",
) {
    ...
    Strategy.Instance {
        ...
        val risingTrendM5 = m5CandlePctChange[m5Series.lastIndex - 1] > percentChange
        val risingTrendDaily = dailyCandlePctChange[dailySeries.lastIndex - 1] > percentChange
        val risingTrend = risingTrendM5 && risingTrendDaily
        ...
        val fallingTrendM5 = m5CandlePctChange[m5Series.lastIndex - 1] < percentChange.negate()
        val fallingTrendDaily = dailyCandlePctChange[dailySeries.lastIndex - 1] < percentChange.negate()
        val fallingTrend = fallingTrendM5 && fallingTrendDaily
