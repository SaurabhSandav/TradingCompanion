...
fun main() {
    ...
    val origDateTimePattern = "ddMMyyyyHHmmss"
    origDateTimePattern.forEachIndexed { index, c ->
        val transformed = offsetMapping.originalToTransformed(index)
        println("($c) Orig: $index, Trans: $transformed, Diff: ${transformed-index}")
    }

    println("===========================================")

    val transformedDateTimePattern = "dd:MM:yyyy  HH:mm:ss"
    transformedDateTimePattern.forEachIndexed { index, c ->
        val original = offsetMapping.transformedToOriginal(index)
        println("($c) Trans: $index, Orig: $original, Diff: ${index-original}")
    }
}
*/
